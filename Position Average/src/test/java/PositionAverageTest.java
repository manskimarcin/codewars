...
public class PositionAverageTest {
    ...
    public void testCompareStrings(){
        assertEquals(3,PositionAverage.compareStrings("466960","069060"));
        assertEquals(1, PositionAverage.compareStrings("699990","640646"));
        assertEquals(7, PositionAverage.compareStrings("4444444","4444444"));
        assertEquals(0, PositionAverage.compareStrings("",""));
    }
